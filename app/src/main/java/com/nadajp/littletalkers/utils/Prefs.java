...
public class Prefs {
    ...
    public static String getKidName(Context context) {
        SharedPreferences sharedPrefs = context.getSharedPreferences(
                SHARED_PREFS_FILENAME, Context.MODE_PRIVATE);
        return sharedPrefs.getString(KID_NAME, null);
    }

    public static void saveKidName(Context context, String kidName) {
        SharedPreferences sharedPrefs = context.getSharedPreferences(
                SHARED_PREFS_FILENAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putString(KID_NAME, kidName);
        editor.commit();
    }
    ...
    public static void saveSortColumnId(Context context, int id) {

        SharedPreferences sharedPrefs = context.getSharedPreferences(
                SHARED_PREFS_FILENAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putInt(SORT_COLUMN_ID, id);
        editor.commit();
    }

    public static void saveIsAscending(Context context, boolean asc) {
        SharedPreferences sharedPrefs = context.getSharedPreferences(
                SHARED_PREFS_FILENAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putBoolean(Prefs.SORT_ASCENDING, asc);
    }
}
