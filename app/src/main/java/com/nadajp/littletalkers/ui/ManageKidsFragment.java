...
public class ManageKidsFragment extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private KidsListFragmentInteractionListener mListener;
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        mListener.onSelectKid(mKids.get(position));
    }
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof KidsListFragmentInteractionListener) {
            mListener = (KidsListFragmentInteractionListener) activity;
        } else {
